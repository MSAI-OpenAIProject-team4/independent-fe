...
const Campaign = () => {
    const campaigns = [
        ...
        },
        {
            ...
            company: "한국해비타트",
            description: "현재 정부의 적절한 지원을 받고 있는 독립유공자 후손들은 약 10%에 해당됩니다. 독립운동가 후손들이 편하게 여생을 보낼 수 있는 집과 환경이 필요합니다. 2017년부터 2022년까지 총 86가구의 주거환경을 개선했습니다.",
            image: "https://habitat.or.kr/landing/2025/independence/images/bg_visual.png",
